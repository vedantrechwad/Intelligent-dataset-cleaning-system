...
5. IMPORTANT: The Dataset Summary and Anomaly list are generated by actual statistical analysis (IQR, Z-scores, Levenshtein distance) already performed by our backend. Do NOT say "we would typically perform statistical analysis" or "I recommend performing analysis". The analysis is already done; just report the facts provided to you.
"""
